...
speedwalkBot.paths["tochess"] = {"enter", "1e","climb pipe", "dungeons clear all"}
speedwalkBot.paths["fromchess"] = {"slide", "1w", "vortex"}
speedwalkBot.paths["toalphabet"] = {"enter", "2e, d","mission ask"}
...
speedwalkBot.paths["tohotel"] = {"enter", "3e 2s 2e s 2w","buy hotel transylvania", "theatre", "e", "enter", "pull rug", "dispose ticket", "dungeons clear all"}
speedwalkBot.paths["fromhotel"] = {"out", "out", "1w s 2e n 2w 2n 3w","vortex"}
speedwalkBot.paths["tospirit"] = {"enter", "4w", "embrace void", "dungeons clear all"}
speedwalkBot.paths["fromspirit"] = {"leave", "1w 3e", "vortex"}
speedwalkBot.paths["todftree"] = {"enter", "3w n", "enter", "dungeons clear all"}
...
speedwalkBot.paths["toanchorman"] = {"enter", "3e 2s 2e s 2w","buy anchorman", "theatre", "2w", "watch", "dispose ticket", "dungeons clear all"}
...
speedwalkBot.paths["tomj"] = {"enter", "2w 2s", "draw tile", "dungeons clear all"}
speedwalkBot.paths["frommj"] = {"portal", "s", "exit", "2n 2e", "vortex"}
speedwalkBot.paths["tochins"] = {"enter", "3e 2s 2e n 3e s 2w", "stroke pelt", "gate", "dungeons clear all"}
...
speedwalkBot.paths["torimalkin"] = {"portal", "12n", "leave", "8n 4e 6n 7w s", "slide rock", "dungeons clear all"}
speedwalkBot.paths["fromrimalkin"] = {"leave", "1n 2w", "portal"}
speedwalkBot.paths["tozel"] = {"portal", "12n", "leave", "3n 4w", "enter" }
...
speedwalkBot.paths["tozodiac"] = {"portal", "15e", "leave", "4e ne ne n ne ne 10e", "step through", "dungeons clear all"}
speedwalkBot.paths["fromzodiac"] = {"leave", "7w", "portal"}
...
speedwalkBot.paths["toaegis"] = {"enter", "1u 3e d e", "path", "6e 15n 5e n e n e n 7e", "bridge", "1e 2se 2e", "enter", "dungeons clear all"}
speedwalkBot.paths["fromaegis"] = { "exit", "2w 2nw w", "bridge", "8w s w s w s 5w 15s 6w", "path", "1w u 3w d", "out" }
speedwalkBot.paths["toz"] = {"enter", "1u 3n w n", "play", "dungeons clear all"}
...
speedwalkBot.paths["tokilton"] = {"enter", "1u 4n d 2n e n 18e 16n", "dungeons clear all"}
...
speedwalkBot.paths["todogs"] = {"(scaler 130) (enter) 2w n (follow tracks) n n (climb gate) n w 2n e n", "dungeons clear all"}
